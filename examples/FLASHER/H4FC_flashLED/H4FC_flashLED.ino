...
void h4setup() { // H4 constructor starts Serial
    ...
    h4fc.flashLED(1024,LED_BUILTIN,ULED_ACTIVE); // LED depends on platform

    h4.once(10000,[](){ 
      h4fc.flashLED(512,LED_BUILTIN,ULED_ACTIVE); // LED depends on platform
    });
    h4.once(20000,[](){ 
      h4fc.flashLED(256,LED_BUILTIN,ULED_ACTIVE); // LED depends on platform
    });
    h4.once(30000,[](){ 
      h4fc.flashLED(128,LED_BUILTIN,ULED_ACTIVE); // LED depends on platform
    });
    h4.once(40000,[](){ 
      h4fc.flashLED(64,LED_BUILTIN,ULED_ACTIVE); // LED depends on platform
    });
    h4.once(60000,[](){ 
