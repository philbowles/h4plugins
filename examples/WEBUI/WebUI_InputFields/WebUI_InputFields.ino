...
void onUiChange(const string& name,const string& value){ 
  if(name=="autoOff"){
    ...
    if(name=="Select"){
      ...
      if(value=="llll") h4wifi.uiSetLabel(USER_TEXT_NAME,lowercase(usertext)); 
      if(value=="UUUU") h4wifi.uiSetLabel(USER_TEXT_NAME,uppercase(usertext)); 
      if(value=="BcBc") h4wifi.uiSetLabel(USER_TEXT_NAME,usertext); 
    }
...
//  create your own UI fields and "setter" functions
    ...
    h4wifi.uiAddLabel(USER_TEXT_NAME,usertext);
