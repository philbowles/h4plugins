...
void h4setup() { // H4 constructor starts Serial 
    ...
    h4gm.Raw(USER_BTN,INPUT,UB_ACTIVE,[](H4GPIOPin* ptr){
        H4GM_PIN(Raw); // Required! turns ptr into correct pin-> pointer
...
// optional: limit pin to 4 transitions / sec (high values prevent MCU overload. Rarely needed, but useful)
    h4gm.throttle(USER_BTN,4,[](bool b){ Serial.print(b ? "":"Un");Serial.println("Throttled"); });
//  can also just do:
//  h4gm.throttle(USER_BTN,4);
}
