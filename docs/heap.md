...
Emits `H4P_EVENT_HEAP` events at a user-defined frequency. The event message contains thre string respresentation of the amount of free heap space.
...
| :----------   | :--- | :--- | :-------: | :---    |
|H4P_TRID_HLOG|HLOG|every|:tick:|Event frequency timer|
